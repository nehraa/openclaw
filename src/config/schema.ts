...
const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.web.search.apiKey": "Brave Search API Key (provider=brave)",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.provider": 'Search provider ("perplexity" default, or "brave").',
  "tools.web.search.apiKey":
    "Brave Search API key (provider=brave; fallback: BRAVE_API_KEY env var).",
